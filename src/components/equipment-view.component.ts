        ...
        <div class="bg-gradient-to-r from-orange-600 via-amber-600 to-yellow-600 p-8 rounded-3xl shadow-xl border border-orange-500/30 flex flex-col md:flex-row justify-between items-start md:items-center gap-6 relative overflow-hidden">
            ...
            <div class="relative z-10">
                ...
                <div class="flex items-center gap-4 mt-2">
                    <p class="text-orange-100 text-sm font-medium ml-1">Gestione e manutenzione attrezzature operative</p>
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm border-2 transition-all duration-300 group"
                    ...
                    <div class="flex items-start gap-4">
                        <div class="flex-shrink-0 w-14 h-14 rounded-2xl flex items-center justify-center transition-all duration-300"
                            ...
                            <i class="fa-solid text-2xl" [class.fa-check-circle]="check.checked" [class.fa-tools]="!check.checked"></i>
                        </div>
                            ...
                            <div class="flex items-center gap-2">
                                @if (check.checked) {
                                    ...
                                    <span class="inline-flex items-center gap-1.5 px-3 py-1 bg-slate-200 text-slate-600 text-xs font-bold rounded-full">
                                        <i class="fa-regular fa-circle"></i> DA COMPLETARE
                                    </span>
                                }
                            </div>
                        </div>
        ...
        @if (showStandardInfo()) {
            <div class="fixed inset-0 z-[110] flex items-center justify-center p-4">
                ...
                <div class="relative bg-white w-full max-w-md max-h-[90vh] rounded-[40px] shadow-2xl overflow-hidden animate-slide-up border border-slate-100 flex flex-col">
                    <div class="p-8 bg-gradient-to-br from-orange-700 to-amber-900 text-white relative flex-shrink-0">
                        <div class="absolute top-0 right-0 p-6 opacity-10 pointer-events-none -rotate-12 translate-x-2">
                            <i class="fa-solid fa-toolbox text-8xl"></i>
                        </div>
                        <div class="relative z-10">
                    ...
                    <div class="p-8 pt-6 space-y-6 overflow-y-auto custom-scrollbar flex-1">
                        <div class="space-y-3">
                            <h4 class="text-[10px] font-black text-orange-600 uppercase tracking-widest flex items-center gap-2">
                                <i class="fa-solid fa-file-contract text-xs"></i> 01. Documentazione
                            </h4>
                            <div class="bg-orange-50/50 p-5 rounded-2xl border border-orange-100 text-xs text-slate-700 font-medium leading-relaxed">
                                Conservare i manuali d'uso e manutenzione di tutte le attrezzature. Registrare ogni intervento tecnico effettuato.
                            </div>
                        </div>

                        <div class="space-y-3">
                            <h4 class="text-[10px] font-black text-orange-600 uppercase tracking-widest flex items-center gap-2">
                                <i class="fa-solid fa-calendar-check text-xs"></i> 02. Pianificazione
                            </h4>
                            <div class="bg-orange-50/50 p-5 rounded-2xl border border-orange-100 text-xs text-slate-700 font-medium leading-relaxed">
                                Effettuare controlli periodici programmati per prevenire guasti e garantire il corretto funzionamento dei macchinari.
                            </div>
                        </div>

                        <div class="space-y-3">
                            <h4 class="text-[10px] font-black text-orange-600 uppercase tracking-widest flex items-center gap-2">
                                <i class="fa-solid fa-triangle-exclamation text-xs"></i> 03. Sicurezza
                            </h4>
                            <div class="bg-orange-50/50 p-5 rounded-2xl border border-orange-100 text-[10px] font-bold text-slate-500 italic">
                                Verificare l'efficienza dei sistemi di sicurezza e delle protezioni delle macchine prima di ogni utilizzo.
                            </div>
                        </div>
                    </div>
